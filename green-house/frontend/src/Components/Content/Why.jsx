        ...
        <div className="whyContainer">
            ...
            <div className="why-content">
                <div className="whyText">
                    ...
                    <p>
                    To reduce the amount of CO2 produced by transportation on a day-to-day basis for more ecologic cities and with the goal of raising awareness to people.
                    </p>
                </div>
